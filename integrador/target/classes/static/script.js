...
const apiBaseURL = 'https://osdrakedosenai.azurewebsites.net/jogador';  // URL da API
...
function insertItem(item) {
  ...
  tr.innerHTML = `
    <td class="foto">
      <img class="perfil" src="https://osdrakedosenai.azurewebsites.net/imagens/${item.foto}"   alt="Foto do Jogador">
    </td>
    <td>${item.nome}</td>
    <td>${item.idade}</td>
    <td>${item.time}</td>
