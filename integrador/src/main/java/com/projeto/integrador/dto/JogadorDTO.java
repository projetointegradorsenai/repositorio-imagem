...
public class JogadorDTO {
    ...
    private int camisa;
    private String foto;  // Campo para armazenar o nome da imagem
    ...
    // Construtor para converter Jogador (do banco de dados) para JogadorDTO
    public JogadorDTO(Jogador jogador) {
        ...
        this.foto = jogador.getFoto();  // Aqui salva o nome da imagem
    }
